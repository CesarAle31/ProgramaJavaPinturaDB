-- =====================================================
-- PROCEDIMIENTOS ALMACENADOS PARA TABLA 'pintura'
-- Base de Datos: IPESAPinturas
-- Motor: MariaDB
-- =====================================================

-- =====================================================
-- PROCEDIMIENTO 1: sp_agregar_pintura
...
-- =====================================================
-- PROCEDIMIENTO 2: sp_buscar_pintura
...
-- =====================================================
-- PROCEDIMIENTO 3: sp_actualizar_pintura
...
-- =====================================================
-- PROCEDIMIENTO 4: sp_eliminar_pintura
...
-- =====================================================
-- Para verificar que los procedimientos fueron creados exitosamente:
-- SHOW PROCEDURE STATUS WHERE db = 'IPESAPinturas';
--
-- Ejemplos de invocación desde cliente:
--
-- 1. Agregar una pintura:
-- CALL sp_agregar_pintura(1, 5, 'Pintura Blanca', 'Blanco', '5.0', 50, 125.75, 'Lata 5L');
--
-- 2. Buscar una pintura por ID:
-- CALL sp_buscar_pintura(1);
--
-- 3. Actualizar una pintura:
-- CALL sp_actualizar_pintura(1, 1, 5, 'Pintura Blanca Premium', 'Blanco', '5.0', 45, 135.00, 'Lata 5L');
--
